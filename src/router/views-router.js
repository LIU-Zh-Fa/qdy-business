    ...
    this.$router.$viewsRouter = {
        ...
        formatRoutes: function (aMenu = [], first) {
            ...
            const propsDefault = {
                ...
                islink: propsConfig.islink || 'requestable',
            }
            ...
            for (let i = 0; i < aMenu.length; i++) {
                ...
                //特殊处理组件 component = validatenull(children)?("views" + oMenu.component):oMenu.component;
                component = oMenu.component,

                name = oMenu[propsDefault.label],
                icon = oMenu[propsDefault.icon],
                children = oMenu[propsDefault.children],
                  islink  = oMenu[propsDefault.islink],
                  meta = oMenu[propsDefault.meta] || {
                    keepAlive: Number(oMenu['keepAlive']) === 0
                };
                const isChild = !validatenull(children);
                const oRouter = {
                    path: path,
                    component:((resolve) => {
                        // 判断是否为首路由
                    ...
                    // })(),
                    // 处理是否为一级路由
                    children: (children != null && children && children.length) ? (() => {
